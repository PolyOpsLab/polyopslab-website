...
.content .desc {
  ...
  max-width: 680px;
      ...
      <header className="header">
        <Link className="brand" href="/" rel="noopener noreferrer">
          POLYOPSLAB
        </Link>
      </header>
      ...
      {/* Hero */}
      <main className="hero mx-10 md:mx-0">
        <div>
          <h1 className="title">We've received your query.</h1>
          <p className="subtitle">
            Thank you for reaching out to PolyOpsLab. Our team will get back to
            you shortly.
          </p>
          <Button
      ...
      <section className="content">
        <div className="heading">PolyOpsLab</div>
        <p className="desc">
          PolyOpsLab is a software agency specializing in modern web
          applications, AI-powered solutions, and scalable digital products for
