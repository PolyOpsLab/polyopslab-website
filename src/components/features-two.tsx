        ...
        <div>
          <div className="p-6 sm:p-12">
            <span className="text-muted-foreground flex items-center gap-2">
              ...
              Engineering Transparency & Status Sync
            </span>

            <p className="mt-8 text-2xl font-semibold">
              We onboard clients from all over the world!!.
            </p>
          </div>
        ...
        <div className="overflow-hidden border-t bg-zinc-50 p-6 sm:p-12 md:border-0 md:border-l dark:bg-transparent">
          <div className="relative z-10">
            ...
            <p className="my-8 text-2xl font-semibold">
              Reach out via email or through contact-us form for any assistance.
            </p>
          </div>
          <div aria-hidden className="flex flex-col gap-8">
            ...
            <div>
              <div className="rounded-(--radius) mb-1 ml-auto w-3/5 bg-blue-600 p-3 text-xs text-white">
                Thank you for reaching out to us. We're here to assist, clarify,
                and guide you whenever you need us.
              </div>
